            ...
            <div class="h-[100%] flex ml-4 justify-between flex-col">
                ...
                <div class="flex items-end">
                    ...
                    <div class="px-3 py-1 flex rounded-md text-white">
                        ...
                        <span class="text-gray-400 group-hover:text-[#9F94CB] ml-1">Iraq</span>
                    </div>
                    ...
                    <div class="px-3 py-1 flex rounded-md text-white">
                        ...
                        <span class="text-gray-400 group-hover:text-[#9F94CB] ml-1">2weeks ago</span>
                    </div>
                </div>
