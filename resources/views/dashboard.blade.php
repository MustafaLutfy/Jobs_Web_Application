...
<x-app-layout>
        ...
        <!-- image -->
            <div class="h-[100%] w-[40vw] flex items-center justify-center sm:w-[350vw]:hidden">
                <div class="w-[50%] h-[50%] relative">
                    ...
                    <span
                        class="px-[25px] z-0 py-[10px] text-[24px] bg-[#FFE8D0] text-[#b497dd] rounded-md absolute top-20 -left-12 ">{{__('Marketing')}}</span>
                    <span
                        class="px-[25px] z-0 py-[10px] text-[24px] bg-[#FFE8D0] text-[#b497dd] rounded-md absolute top-10 -right-12 ">{{__('Coding')}}</span>
                    <span
                        class="px-[25px] z-0 py-[10px] text-[24px] bg-[#FFE8D0] text-[#b497dd] rounded-md absolute bottom-4 -right-12 ">{{__('Design')}}</span>
                </div>
            </div>
    
            <div class="flex justify-center items-end flex-col h-[100%] text-right w-[60vw] p-40">
                <!-- heading -->
                <h1 class="text-[#7B6AB8] text-[40px] 2xl:text-[60px] font-bold">{{__('Connecting talents')}}<br>{{__('with apportionities')}}</h1>
                <p class="mt-6 md:text-[18px]">{{__('Our platform was designed to connect talented indivisuals live you with a vast array of job opening cross various indastries and sectors')}}
                </p>
                <div>
                <!-- job type button-->
                    <div class="flex justify-end mt-6 gap-10">
                        <div class="inline-flex text-lg font-semibold items-center">
                            ...
                            <label class="mt-px cursor-pointer select-none text-gray-700" for="html">
                                {{__('Full Time')}}
                            </label>
                        </div>
                        <div class="inline-flex text-lg font-semibold items-center">
                            ...
                            <label class="mt-px cursor-pointer select-none text-gray-700" for="react">
                                {{__('Part Time')}}
                            </label>
                        </div>
                    </div>
                ...
                <div class="flex bg-white p-2 rounded-lg w-fit">
                    <input
                        ...
                        placeholder="{{__('Search for anything...')}}" name="search" type="text">
                    <button class="px-6 py-2 2xl:px-12 2xl:py-4 bg-[#7767b5] ml-auto text-[22px] text-white rounded-md">{{__('Search')}}</button>
                </div>
            </div>
            <!-- end search bar -->
    ...
    <!-- categories -->
    @if(Session::get('locale') == 'ar')
    <h1 class="text-4xl pr-40 pb-10 text-right bg-[#F7F7F8] font-semibold">{{__('categories that matches your skills')}}</h1>

    <div class="flex justify-end {{ Session::get('locale') == 'ar' ? 'text-right' : ''}} gap-8 px-40 pb-20 bg-[#F7F7F8] ">
        <div
            ...
            <h2 class="text-2xl mx-4 text-gray-700 group-hover:text-white transition-all duration-300">{{__('Design')}}</h2>
            <p class="mx-4 text-gray-700 group-hover:text-white transition-all duration-300">{{__('new jobs are available')}}
            </p>
        </div>
        ...
        <div
            ...
            <h2 class="text-2xl mx-4 text-gray-700 group-hover:text-white transition-all duration-300">{{__('Coding')}}</h2>
            <p class="mx-4 text-gray-700 group-hover:text-white transition-all duration-300">{{__('new jobs are available')}}
            </p>
        </div>
        ...
        <div
            ...
            <h2 class="text-2xl mx-4 text-gray-700 group-hover:text-white transition-all duration-300">{{__('Marketing')}}</h2>
            <p class="mx-4 text-gray-700 group-hover:text-white transition-all duration-300">{{__('new jobs are available')}}
            </p>
        </div>
        <div
            ...
            <h2 class="text-2xl mx-4 text-gray-700 group-hover:text-white transition-all duration-300">{{__('Cyber Security')}}</h2>
            <p class="mx-4 text-gray-700 group-hover:text-white transition-all duration-300">{{__('new jobs are available')}}
            </p>
        </div>
        ...
        <div
            ...
            <h2 class="text-2xl mx-4 text-gray-700 group-hover:text-white transition-all duration-300">{{__('More')}}</h2>
            <p class="mx-4 text-gray-700 group-hover:text-white transition-all duration-300">{{__('Find more catigories')}}</p>
        </div>
    </div>
    <!-- end categories -->
    @else
    <h1 class="text-4xl pl-40 pb-10 bg-[#F7F7F8] font-semibold">{{__('categories that matches your skills')}}</h1>
    ...
    <div style="background-image:url({{ url('assets/pexels-sora-shimazaki-5668859.jpg') }});"
        ...
        <h1 class="text-white text-7xl z-10 font-semibold text-center leading-[100px]">"{{__('Discover Endless Possibilities')}}
            <br> {{__('for Your Future Career')}}"
        </h1>
    </div>
        ...
        <a href="{{url('offer/' . $offer->id)}}">
            <div 
                ...
                <img class="h-[94%] rounded-md"
                    src="{{ $offer->company->cp_logo_path == 0 ? url('assets/sample.jpg') : url('users_images/' . "download.png") }}"
                    alt="">
