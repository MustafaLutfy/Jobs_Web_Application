...
<head>
    ...
    <title>{{Auth::guard('company')->user()->cp_name}}</title>
        ...
        <aside class="z-20 hidden w-64 overflow-y-auto bg-white h-screen dark:bg-gray-800 md:block flex-shrink-0">
            <div class="py-4 text-gray-500 dark:text-gray-400">
                <a class="ml-6 text-lg font-bold text-gray-800 dark:text-gray-200" href="#">
                    {{Auth::guard('company')->user()->cp_name}}
                </a>
                <ul class="mt-6">
                    ...
                    <li class="relative px-6 py-3">
                    @if (Route::currentRouteName() == 'get.company.offers')
                    <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
                      aria-hidden="true"></span>
                                ...
                                <ul x-transition:leave="transition ease-in duration-150"
                                    ...
                                    <li class="flex">
                                        <a class="inline-flex items-center justify-between w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200"
                                            href="{{route('get.chats.page')}}">
                                            <span>Messages</span>
                                            <span
                                                class="inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-red-600 bg-red-100 rounded-full dark:text-red-100 dark:bg-red-600">
                                               {{App\Models\Message::where('company_id', Auth::guard('company')->user()->id)->get()->unique('user_id')->count()}}
                                            </span>
                                        </a>
                                    </li>
                                    <li class="flex">
