...
<section class="p-10 flex justify-center">
    <div class="bg-white w-[80vw] h-auto px-10 rounded-xl shadow-md">
    <div class="flex items-center h-auto py-10 w-full">
        ...
        <div class="flex flex-col h-auto w-full border-b-2 border-gray-200">
            ...
            <h3 class="text-[#7868B6] font-semibold mt-2">Tecnology Company</h3>
                ...
                <a class="group flex items-center justify-center w-36 p-2 my-6 rounded border-2 border-gray-200 hover:border-[#7868B6] transtion duration-300" href="{{route('get.chat', $company->id)}}">
